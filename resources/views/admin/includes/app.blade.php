...
<head>
  ...
  <title>Lynce | Listagem de Empresa</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Lynce Turismo</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('getCheckIn')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check in</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('getCheckOut')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check out</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="#">Lynce</a>.</strong>
  </footer>
